...
- Source hash: `86e4da3eb22bf2ddd5820e2de65ad30b1a10ece9a55d4ef4a93e8ae22dfd6c4b`
- Total routes: 298
...
| POST | `/api/browser/interactive/sessions` | browser | no | yes | packages/gateway/src/server.ts:53882 |
| POST | `/api/browser/interactive/sessions/:liveSessionId/actions` | browser | no | yes | packages/gateway/src/server.ts:54043 |
| DELETE | `/api/browser/interactive/sessions/:liveSessionId` | browser | no | yes | packages/gateway/src/server.ts:54117 |
| POST | `/api/browser/interactive/run` | browser | no | yes | packages/gateway/src/server.ts:54178 |
| POST | `/api/browser/test` | browser | no | yes | packages/gateway/src/server.ts:54336 |
| GET | `/api/browser/history` | browser | no | yes | packages/gateway/src/server.ts:54472 |
| GET | `/api/browser/history/:runId` | browser | no | yes | packages/gateway/src/server.ts:54492 |
| GET | `/api/browser/artifacts/:handle` | browser | no | yes | packages/gateway/src/server.ts:54504 |
| POST | `/api/bootstrap/vendor` | bootstrap | no | yes | packages/gateway/src/server.ts:54523 |
| PATCH | `/api/tools/:toolName` | tools | no | yes | packages/gateway/src/server.ts:54588 |
| GET | `/api/llm/limits` | llm | no | yes | packages/gateway/src/server.ts:54620 |
| PUT | `/api/llm/limits` | llm | no | yes | packages/gateway/src/server.ts:54668 |
| GET | `/api/llm/auth-profiles` | llm | no | yes | packages/gateway/src/server.ts:54719 |
| PUT | `/api/llm/auth-profiles/:profileId` | llm | no | yes | packages/gateway/src/server.ts:54725 |
| GET | `/api/llm/costs` | llm | no | yes | packages/gateway/src/server.ts:54813 |
| GET | `/api/llm/routing/effective` | llm | no | yes | packages/gateway/src/server.ts:54954 |
| GET | `/api/skills` | skills | no | yes | packages/gateway/src/server.ts:54997 |
| GET | `/api/skills/lifecycle` | skills | no | yes | packages/gateway/src/server.ts:55003 |
| GET | `/api/skills/release-gate` | skills | no | yes | packages/gateway/src/server.ts:55009 |
| POST | `/api/skills/release-gate/evaluate` | skills | no | yes | packages/gateway/src/server.ts:55015 |
| POST | `/api/skills/curator/run` | skills | no | yes | packages/gateway/src/server.ts:55044 |
| GET | `/api/skills/catalog` | skills | no | yes | packages/gateway/src/server.ts:55072 |
| POST | `/api/skills/catalog/entries/upsert` | skills | no | yes | packages/gateway/src/server.ts:55090 |
| POST | `/api/skills/catalog/entries/remove` | skills | no | yes | packages/gateway/src/server.ts:55168 |
| POST | `/api/skills/runtime-contracts/upsert` | skills | no | yes | packages/gateway/src/server.ts:55236 |
| POST | `/api/skills/install` | skills | no | yes | packages/gateway/src/server.ts:55323 |
| POST | `/api/skills/remove` | skills | no | yes | packages/gateway/src/server.ts:55457 |
| POST | `/api/skills/resync` | skills | no | yes | packages/gateway/src/server.ts:55522 |
| POST | `/api/skills/autodiscover` | skills | no | yes | packages/gateway/src/server.ts:55576 |
| POST | `/api/skills/reload` | skills | no | yes | packages/gateway/src/server.ts:55654 |
| PUT | `/api/skills/:skillName/lifecycle` | skills | no | yes | packages/gateway/src/server.ts:55671 |
| POST | `/api/skills/:skillName/invoke` | skills | no | yes | packages/gateway/src/server.ts:55713 |
| GET | `/api/pairings` | pairings | no | yes | packages/gateway/src/server.ts:55777 |
| POST | `/api/pairings/:channel/:senderId/approve` | pairings | no | yes | packages/gateway/src/server.ts:55785 |
| POST | `/api/pairings/:channel/:senderId/revoke` | pairings | no | yes | packages/gateway/src/server.ts:55798 |
| POST | `/api/ingress/telegram` | ingress | yes | yes | packages/gateway/src/server.ts:55811 |
| POST | `/api/telegram/webhook` | telegram | yes | yes | packages/gateway/src/server.ts:58984 |
| POST | `/api/telegram/smoke-test` | telegram | no | yes | packages/gateway/src/server.ts:59004 |
| POST | `/api/telegram/commands/sync` | telegram | no | yes | packages/gateway/src/server.ts:59053 |
| GET | `/api/events` | events | no | yes | packages/gateway/src/server.ts:59087 |
| GET | `/api/events/stream` | events | no | yes | packages/gateway/src/server.ts:59097 |
| GET | `/api/office/presence` | office | no | yes | packages/gateway/src/server.ts:59151 |
| GET | `/api/office/stream` | office | no | yes | packages/gateway/src/server.ts:59167 |
| GET | `/api/bff/cards` | bff | no | yes | packages/gateway/src/server.ts:59216 |
| GET | `/api/bff/board` | bff | no | yes | packages/gateway/src/server.ts:59348 |
| GET | `/api/bff/chats` | bff | no | yes | packages/gateway/src/server.ts:59403 |
| GET | `/api/bff/health-cards` | bff | no | yes | packages/gateway/src/server.ts:59424 |
| GET | `/api/audit` | audit | no | yes | packages/gateway/src/server.ts:59437 |
| GET | `/api/metrics` | metrics | no | yes | packages/gateway/src/server.ts:59443 |
| POST | `/api/security/elevated-check` | security | no | yes | packages/gateway/src/server.ts:59451 |
| GET | `/api/security/token-status` | security | no | yes | packages/gateway/src/server.ts:59545 |
| GET | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:59559 |
| POST | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:59570 |
| GET | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:59583 |
| POST | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:59589 |
| GET | `/api/remediation/plans` | remediation | no | yes | packages/gateway/src/server.ts:59662 |
| POST | `/api/remediation/plans/:planId/approve` | remediation | no | yes | packages/gateway/src/server.ts:59668 |
| POST | `/api/remediation/plans/:planId/execute` | remediation | no | yes | packages/gateway/src/server.ts:59679 |
| GET | `/api/remediation/outcomes` | remediation | no | yes | packages/gateway/src/server.ts:59744 |
| GET | `/api/frontier/contracts` | frontier | no | yes | packages/gateway/src/server.ts:59893 |
| GET | `/api/frontier/governance` | frontier | no | yes | packages/gateway/src/server.ts:59914 |
| POST | `/api/frontier/governance/principals` | frontier | no | yes | packages/gateway/src/server.ts:59944 |
| POST | `/api/frontier/governance/companies` | frontier | no | yes | packages/gateway/src/server.ts:59983 |
| POST | `/api/frontier/governance/memberships` | frontier | no | yes | packages/gateway/src/server.ts:60036 |
| POST | `/api/frontier/governance/grants` | frontier | no | yes | packages/gateway/src/server.ts:60073 |
| POST | `/api/frontier/governance/invites` | frontier | no | yes | packages/gateway/src/server.ts:60104 |
| POST | `/api/frontier/governance/invites/accept` | frontier | no | yes | packages/gateway/src/server.ts:60138 |
| POST | `/api/frontier/governance/join-requests` | frontier | no | yes | packages/gateway/src/server.ts:60167 |
| POST | `/api/frontier/governance/join-requests/:requestId/decision` | frontier | no | yes | packages/gateway/src/server.ts:60191 |
| POST | `/api/frontier/governance/claims/challenge` | frontier | no | yes | packages/gateway/src/server.ts:60223 |
| POST | `/api/frontier/governance/claims/complete` | frontier | no | yes | packages/gateway/src/server.ts:60246 |
| GET | `/api/frontier/issues/locks` | frontier | no | yes | packages/gateway/src/server.ts:60275 |
| POST | `/api/frontier/issues/:issueId/wakeup` | frontier | no | yes | packages/gateway/src/server.ts:60302 |
| POST | `/api/frontier/issues/:issueId/release` | frontier | no | yes | packages/gateway/src/server.ts:60332 |
| POST | `/api/frontier/issues/repair` | frontier | no | yes | packages/gateway/src/server.ts:60357 |
| GET | `/api/frontier/portability/export` | frontier | no | yes | packages/gateway/src/server.ts:60375 |
| POST | `/api/frontier/portability/import/preview` | frontier | no | yes | packages/gateway/src/server.ts:60395 |
| POST | `/api/frontier/portability/import/apply` | frontier | no | yes | packages/gateway/src/server.ts:60421 |
| GET | `/api/frontier/adapters/contract` | frontier | no | yes | packages/gateway/src/server.ts:60451 |
| GET | `/api/frontier/adapters/diagnostics` | frontier | no | yes | packages/gateway/src/server.ts:60457 |
| GET | `/api/frontier/runs/:runId/events` | frontier | no | yes | packages/gateway/src/server.ts:60463 |
| GET | `/api/frontier/runs/:runId/logs` | frontier | no | yes | packages/gateway/src/server.ts:60500 |
| GET | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:60534 |
| PUT | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:60549 |
| POST | `/api/frontier/deployment/doctor` | frontier | no | yes | packages/gateway/src/server.ts:60589 |
| GET | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:60679 |
| PUT | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:60685 |
| GET | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:60738 |
| POST | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:60750 |
| GET | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:60779 |
| POST | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:60791 |
| POST | `/api/frontier/benchmark/delta` | frontier | no | yes | packages/gateway/src/server.ts:60813 |
| POST | `/api/frontier/critic` | frontier | no | yes | packages/gateway/src/server.ts:60875 |
| POST | `/api/frontier/remediation/plans` | frontier | no | yes | packages/gateway/src/server.ts:60923 |
| GET | `/api/frontier/release/gate` | frontier | no | yes | packages/gateway/src/server.ts:60967 |
| POST | `/api/frontier/certification/report` | frontier | no | yes | packages/gateway/src/server.ts:61024 |
| GET | `/api/certification/runtime` | certification | no | yes | packages/gateway/src/server.ts:61043 |
| POST | `/api/certification/runtime/report` | certification | no | yes | packages/gateway/src/server.ts:61052 |
| GET | `/api/certification/continuity` | certification | no | yes | packages/gateway/src/server.ts:61078 |
| POST | `/api/certification/continuity/report` | certification | no | yes | packages/gateway/src/server.ts:61087 |
| GET | `/api/certification/architecture` | certification | no | yes | packages/gateway/src/server.ts:61109 |
| POST | `/api/certification/architecture/report` | certification | no | yes | packages/gateway/src/server.ts:61118 |
| GET | `/api/vault/status` | vault | no | yes | packages/gateway/src/server.ts:61165 |
| POST | `/api/vault/reset-empty` | vault | no | yes | packages/gateway/src/server.ts:61171 |
| POST | `/api/vault/bootstrap` | vault | no | yes | packages/gateway/src/server.ts:61215 |
| POST | `/api/vault/unlock` | vault | no | yes | packages/gateway/src/server.ts:61249 |
| POST | `/api/vault/lock` | vault | no | yes | packages/gateway/src/server.ts:61309 |
| GET | `/api/vault/secrets` | vault | no | yes | packages/gateway/src/server.ts:61333 |
| PUT | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:61341 |
| POST | `/api/vault/secrets/:name/rotate` | vault | no | yes | packages/gateway/src/server.ts:61400 |
| DELETE | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:61440 |
| POST | `/api/vault/rotate-master-key` | vault | no | yes | packages/gateway/src/server.ts:61506 |
| GET | `/api/backup/export` | backup | no | yes | packages/gateway/src/server.ts:61550 |
| GET | `/` | root | yes | yes | packages/gateway/src/server.ts:61591 |
| GET | `/*` | * | yes | yes | packages/gateway/src/server.ts:61597 |
