...
- Source hash: `4bee15cebfb10fa77091282cf99dec0527e7c16e1859df25b452a73605b028d7`
- Total routes: 295
...
| POST | `/api/browser/interactive/sessions` | browser | no | yes | packages/gateway/src/server.ts:53494 |
| POST | `/api/browser/interactive/sessions/:liveSessionId/actions` | browser | no | yes | packages/gateway/src/server.ts:53655 |
| DELETE | `/api/browser/interactive/sessions/:liveSessionId` | browser | no | yes | packages/gateway/src/server.ts:53729 |
| POST | `/api/browser/interactive/run` | browser | no | yes | packages/gateway/src/server.ts:53790 |
| POST | `/api/browser/test` | browser | no | yes | packages/gateway/src/server.ts:53948 |
| GET | `/api/browser/history` | browser | no | yes | packages/gateway/src/server.ts:54084 |
| GET | `/api/browser/history/:runId` | browser | no | yes | packages/gateway/src/server.ts:54104 |
| GET | `/api/browser/artifacts/:handle` | browser | no | yes | packages/gateway/src/server.ts:54116 |
| POST | `/api/bootstrap/vendor` | bootstrap | no | yes | packages/gateway/src/server.ts:54135 |
| PATCH | `/api/tools/:toolName` | tools | no | yes | packages/gateway/src/server.ts:54200 |
| GET | `/api/llm/limits` | llm | no | yes | packages/gateway/src/server.ts:54232 |
| PUT | `/api/llm/limits` | llm | no | yes | packages/gateway/src/server.ts:54280 |
| GET | `/api/llm/auth-profiles` | llm | no | yes | packages/gateway/src/server.ts:54331 |
| PUT | `/api/llm/auth-profiles/:profileId` | llm | no | yes | packages/gateway/src/server.ts:54337 |
| GET | `/api/llm/costs` | llm | no | yes | packages/gateway/src/server.ts:54425 |
| GET | `/api/llm/routing/effective` | llm | no | yes | packages/gateway/src/server.ts:54566 |
| GET | `/api/skills` | skills | no | yes | packages/gateway/src/server.ts:54609 |
| GET | `/api/skills/lifecycle` | skills | no | yes | packages/gateway/src/server.ts:54615 |
| GET | `/api/skills/release-gate` | skills | no | yes | packages/gateway/src/server.ts:54621 |
| POST | `/api/skills/release-gate/evaluate` | skills | no | yes | packages/gateway/src/server.ts:54627 |
| POST | `/api/skills/curator/run` | skills | no | yes | packages/gateway/src/server.ts:54656 |
| GET | `/api/skills/catalog` | skills | no | yes | packages/gateway/src/server.ts:54684 |
| POST | `/api/skills/catalog/entries/upsert` | skills | no | yes | packages/gateway/src/server.ts:54702 |
| POST | `/api/skills/catalog/entries/remove` | skills | no | yes | packages/gateway/src/server.ts:54780 |
| POST | `/api/skills/runtime-contracts/upsert` | skills | no | yes | packages/gateway/src/server.ts:54848 |
| POST | `/api/skills/install` | skills | no | yes | packages/gateway/src/server.ts:54935 |
| POST | `/api/skills/remove` | skills | no | yes | packages/gateway/src/server.ts:55069 |
| POST | `/api/skills/resync` | skills | no | yes | packages/gateway/src/server.ts:55134 |
| POST | `/api/skills/autodiscover` | skills | no | yes | packages/gateway/src/server.ts:55188 |
| POST | `/api/skills/reload` | skills | no | yes | packages/gateway/src/server.ts:55266 |
| PUT | `/api/skills/:skillName/lifecycle` | skills | no | yes | packages/gateway/src/server.ts:55283 |
| POST | `/api/skills/:skillName/invoke` | skills | no | yes | packages/gateway/src/server.ts:55325 |
| GET | `/api/pairings` | pairings | no | yes | packages/gateway/src/server.ts:55389 |
| POST | `/api/pairings/:channel/:senderId/approve` | pairings | no | yes | packages/gateway/src/server.ts:55397 |
| POST | `/api/pairings/:channel/:senderId/revoke` | pairings | no | yes | packages/gateway/src/server.ts:55410 |
| POST | `/api/ingress/telegram` | ingress | yes | yes | packages/gateway/src/server.ts:55423 |
| POST | `/api/telegram/webhook` | telegram | yes | yes | packages/gateway/src/server.ts:58596 |
| POST | `/api/telegram/smoke-test` | telegram | no | yes | packages/gateway/src/server.ts:58616 |
| POST | `/api/telegram/commands/sync` | telegram | no | yes | packages/gateway/src/server.ts:58665 |
| GET | `/api/events` | events | no | yes | packages/gateway/src/server.ts:58699 |
| GET | `/api/events/stream` | events | no | yes | packages/gateway/src/server.ts:58709 |
| GET | `/api/office/presence` | office | no | yes | packages/gateway/src/server.ts:58763 |
| GET | `/api/office/stream` | office | no | yes | packages/gateway/src/server.ts:58779 |
| GET | `/api/bff/cards` | bff | no | yes | packages/gateway/src/server.ts:58828 |
| GET | `/api/bff/board` | bff | no | yes | packages/gateway/src/server.ts:58960 |
| GET | `/api/bff/chats` | bff | no | yes | packages/gateway/src/server.ts:59015 |
| GET | `/api/bff/health-cards` | bff | no | yes | packages/gateway/src/server.ts:59036 |
| GET | `/api/audit` | audit | no | yes | packages/gateway/src/server.ts:59049 |
| GET | `/api/metrics` | metrics | no | yes | packages/gateway/src/server.ts:59055 |
| POST | `/api/security/elevated-check` | security | no | yes | packages/gateway/src/server.ts:59063 |
| GET | `/api/security/token-status` | security | no | yes | packages/gateway/src/server.ts:59157 |
| GET | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:59171 |
| POST | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:59182 |
| GET | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:59195 |
| POST | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:59201 |
| GET | `/api/remediation/plans` | remediation | no | yes | packages/gateway/src/server.ts:59274 |
| POST | `/api/remediation/plans/:planId/approve` | remediation | no | yes | packages/gateway/src/server.ts:59280 |
| POST | `/api/remediation/plans/:planId/execute` | remediation | no | yes | packages/gateway/src/server.ts:59291 |
| GET | `/api/remediation/outcomes` | remediation | no | yes | packages/gateway/src/server.ts:59356 |
| GET | `/api/frontier/contracts` | frontier | no | yes | packages/gateway/src/server.ts:59505 |
| GET | `/api/frontier/governance` | frontier | no | yes | packages/gateway/src/server.ts:59526 |
| POST | `/api/frontier/governance/principals` | frontier | no | yes | packages/gateway/src/server.ts:59556 |
| POST | `/api/frontier/governance/companies` | frontier | no | yes | packages/gateway/src/server.ts:59595 |
| POST | `/api/frontier/governance/memberships` | frontier | no | yes | packages/gateway/src/server.ts:59648 |
| POST | `/api/frontier/governance/grants` | frontier | no | yes | packages/gateway/src/server.ts:59685 |
| POST | `/api/frontier/governance/invites` | frontier | no | yes | packages/gateway/src/server.ts:59716 |
| POST | `/api/frontier/governance/invites/accept` | frontier | no | yes | packages/gateway/src/server.ts:59750 |
| POST | `/api/frontier/governance/join-requests` | frontier | no | yes | packages/gateway/src/server.ts:59779 |
| POST | `/api/frontier/governance/join-requests/:requestId/decision` | frontier | no | yes | packages/gateway/src/server.ts:59803 |
| POST | `/api/frontier/governance/claims/challenge` | frontier | no | yes | packages/gateway/src/server.ts:59835 |
| POST | `/api/frontier/governance/claims/complete` | frontier | no | yes | packages/gateway/src/server.ts:59858 |
| GET | `/api/frontier/issues/locks` | frontier | no | yes | packages/gateway/src/server.ts:59887 |
| POST | `/api/frontier/issues/:issueId/wakeup` | frontier | no | yes | packages/gateway/src/server.ts:59914 |
| POST | `/api/frontier/issues/:issueId/release` | frontier | no | yes | packages/gateway/src/server.ts:59944 |
| POST | `/api/frontier/issues/repair` | frontier | no | yes | packages/gateway/src/server.ts:59969 |
| GET | `/api/frontier/portability/export` | frontier | no | yes | packages/gateway/src/server.ts:59987 |
| POST | `/api/frontier/portability/import/preview` | frontier | no | yes | packages/gateway/src/server.ts:60007 |
| POST | `/api/frontier/portability/import/apply` | frontier | no | yes | packages/gateway/src/server.ts:60033 |
| GET | `/api/frontier/adapters/contract` | frontier | no | yes | packages/gateway/src/server.ts:60063 |
| GET | `/api/frontier/adapters/diagnostics` | frontier | no | yes | packages/gateway/src/server.ts:60069 |
| GET | `/api/frontier/runs/:runId/events` | frontier | no | yes | packages/gateway/src/server.ts:60075 |
| GET | `/api/frontier/runs/:runId/logs` | frontier | no | yes | packages/gateway/src/server.ts:60112 |
| GET | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:60146 |
| PUT | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:60161 |
| POST | `/api/frontier/deployment/doctor` | frontier | no | yes | packages/gateway/src/server.ts:60201 |
| GET | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:60291 |
| PUT | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:60297 |
| GET | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:60350 |
| POST | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:60362 |
| GET | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:60391 |
| POST | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:60403 |
| POST | `/api/frontier/benchmark/delta` | frontier | no | yes | packages/gateway/src/server.ts:60425 |
| POST | `/api/frontier/critic` | frontier | no | yes | packages/gateway/src/server.ts:60487 |
| POST | `/api/frontier/remediation/plans` | frontier | no | yes | packages/gateway/src/server.ts:60535 |
| GET | `/api/frontier/release/gate` | frontier | no | yes | packages/gateway/src/server.ts:60579 |
| POST | `/api/frontier/certification/report` | frontier | no | yes | packages/gateway/src/server.ts:60636 |
| GET | `/api/certification/runtime` | certification | no | yes | packages/gateway/src/server.ts:60655 |
| POST | `/api/certification/runtime/report` | certification | no | yes | packages/gateway/src/server.ts:60664 |
| GET | `/api/certification/continuity` | certification | no | yes | packages/gateway/src/server.ts:60690 |
| POST | `/api/certification/continuity/report` | certification | no | yes | packages/gateway/src/server.ts:60699 |
| GET | `/api/certification/architecture` | certification | no | yes | packages/gateway/src/server.ts:60721 |
| POST | `/api/certification/architecture/report` | certification | no | yes | packages/gateway/src/server.ts:60730 |
| GET | `/api/vault/status` | vault | no | yes | packages/gateway/src/server.ts:60777 |
| POST | `/api/vault/reset-empty` | vault | no | yes | packages/gateway/src/server.ts:60783 |
| POST | `/api/vault/bootstrap` | vault | no | yes | packages/gateway/src/server.ts:60827 |
| POST | `/api/vault/unlock` | vault | no | yes | packages/gateway/src/server.ts:60861 |
| POST | `/api/vault/lock` | vault | no | yes | packages/gateway/src/server.ts:60921 |
| GET | `/api/vault/secrets` | vault | no | yes | packages/gateway/src/server.ts:60945 |
| PUT | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:60953 |
| POST | `/api/vault/secrets/:name/rotate` | vault | no | yes | packages/gateway/src/server.ts:61012 |
| DELETE | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:61052 |
| POST | `/api/vault/rotate-master-key` | vault | no | yes | packages/gateway/src/server.ts:61118 |
| GET | `/api/backup/export` | backup | no | yes | packages/gateway/src/server.ts:61162 |
| GET | `/` | root | yes | yes | packages/gateway/src/server.ts:61203 |
| GET | `/*` | * | yes | yes | packages/gateway/src/server.ts:61209 |
