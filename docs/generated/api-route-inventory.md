...
- Source hash: `e17083f89f4fee9358c29e5dfc22db0d88c02271cb6514285da5c8a669e35fac`
- Total routes: 299
...
| POST | `/api/browser/playwright-auth/start` | browser | no | no | packages/gateway/src/server.ts:53294 |
| POST | `/api/browser/playwright-auth/save` | browser | no | no | packages/gateway/src/server.ts:53360 |
| POST | `/api/browser/playwright-auth/save-current` | browser | no | no | packages/gateway/src/server.ts:53473 |
| POST | `/api/browser/mobile-handoff/start` | browser | no | no | packages/gateway/src/server.ts:53606 |
| GET | `/api/browser/mobile-handoff/:handoffId/status` | browser | no | no | packages/gateway/src/server.ts:53685 |
| GET | `/mobile-browser-handoff/:handoffId` | mobile-browser-handoff | yes | no | packages/gateway/src/server.ts:53729 |
| POST | `/api/mobile-browser-handoff/:handoffId/complete` | mobile-browser-handoff | no | no | packages/gateway/src/server.ts:53740 |
...
| POST | `/api/telegram/webhook` | telegram | yes | yes | packages/gateway/src/server.ts:60136 |
| POST | `/api/telegram/smoke-test` | telegram | no | yes | packages/gateway/src/server.ts:60156 |
| POST | `/api/telegram/commands/sync` | telegram | no | yes | packages/gateway/src/server.ts:60205 |
| GET | `/api/events` | events | no | yes | packages/gateway/src/server.ts:60239 |
| GET | `/api/events/stream` | events | no | yes | packages/gateway/src/server.ts:60249 |
| GET | `/api/office/presence` | office | no | yes | packages/gateway/src/server.ts:60303 |
| GET | `/api/office/stream` | office | no | yes | packages/gateway/src/server.ts:60319 |
| GET | `/api/bff/cards` | bff | no | yes | packages/gateway/src/server.ts:60368 |
| GET | `/api/bff/board` | bff | no | yes | packages/gateway/src/server.ts:60500 |
| GET | `/api/bff/chats` | bff | no | yes | packages/gateway/src/server.ts:60555 |
| GET | `/api/bff/health-cards` | bff | no | yes | packages/gateway/src/server.ts:60576 |
| GET | `/api/audit` | audit | no | yes | packages/gateway/src/server.ts:60589 |
| GET | `/api/metrics` | metrics | no | yes | packages/gateway/src/server.ts:60595 |
| POST | `/api/security/elevated-check` | security | no | yes | packages/gateway/src/server.ts:60603 |
| GET | `/api/security/token-status` | security | no | yes | packages/gateway/src/server.ts:60697 |
| GET | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:60711 |
| POST | `/api/remediation` | remediation | no | yes | packages/gateway/src/server.ts:60722 |
| GET | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:60735 |
| POST | `/api/remediation/signals` | remediation | no | yes | packages/gateway/src/server.ts:60741 |
| GET | `/api/remediation/plans` | remediation | no | yes | packages/gateway/src/server.ts:60814 |
| POST | `/api/remediation/plans/:planId/approve` | remediation | no | yes | packages/gateway/src/server.ts:60820 |
| POST | `/api/remediation/plans/:planId/execute` | remediation | no | yes | packages/gateway/src/server.ts:60831 |
| GET | `/api/remediation/outcomes` | remediation | no | yes | packages/gateway/src/server.ts:60896 |
| GET | `/api/frontier/contracts` | frontier | no | yes | packages/gateway/src/server.ts:61045 |
| GET | `/api/frontier/governance` | frontier | no | yes | packages/gateway/src/server.ts:61066 |
| POST | `/api/frontier/governance/principals` | frontier | no | yes | packages/gateway/src/server.ts:61096 |
| POST | `/api/frontier/governance/companies` | frontier | no | yes | packages/gateway/src/server.ts:61135 |
| POST | `/api/frontier/governance/memberships` | frontier | no | yes | packages/gateway/src/server.ts:61188 |
| POST | `/api/frontier/governance/grants` | frontier | no | yes | packages/gateway/src/server.ts:61225 |
| POST | `/api/frontier/governance/invites` | frontier | no | yes | packages/gateway/src/server.ts:61256 |
| POST | `/api/frontier/governance/invites/accept` | frontier | no | yes | packages/gateway/src/server.ts:61290 |
| POST | `/api/frontier/governance/join-requests` | frontier | no | yes | packages/gateway/src/server.ts:61319 |
| POST | `/api/frontier/governance/join-requests/:requestId/decision` | frontier | no | yes | packages/gateway/src/server.ts:61343 |
| POST | `/api/frontier/governance/claims/challenge` | frontier | no | yes | packages/gateway/src/server.ts:61375 |
| POST | `/api/frontier/governance/claims/complete` | frontier | no | yes | packages/gateway/src/server.ts:61398 |
| GET | `/api/frontier/issues/locks` | frontier | no | yes | packages/gateway/src/server.ts:61427 |
| POST | `/api/frontier/issues/:issueId/wakeup` | frontier | no | yes | packages/gateway/src/server.ts:61454 |
| POST | `/api/frontier/issues/:issueId/release` | frontier | no | yes | packages/gateway/src/server.ts:61484 |
| POST | `/api/frontier/issues/repair` | frontier | no | yes | packages/gateway/src/server.ts:61509 |
| GET | `/api/frontier/portability/export` | frontier | no | yes | packages/gateway/src/server.ts:61527 |
| POST | `/api/frontier/portability/import/preview` | frontier | no | yes | packages/gateway/src/server.ts:61547 |
| POST | `/api/frontier/portability/import/apply` | frontier | no | yes | packages/gateway/src/server.ts:61573 |
| GET | `/api/frontier/adapters/contract` | frontier | no | yes | packages/gateway/src/server.ts:61603 |
| GET | `/api/frontier/adapters/diagnostics` | frontier | no | yes | packages/gateway/src/server.ts:61609 |
| GET | `/api/frontier/runs/:runId/events` | frontier | no | yes | packages/gateway/src/server.ts:61615 |
| GET | `/api/frontier/runs/:runId/logs` | frontier | no | yes | packages/gateway/src/server.ts:61652 |
| GET | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:61686 |
| PUT | `/api/frontier/deployment` | frontier | no | yes | packages/gateway/src/server.ts:61701 |
| POST | `/api/frontier/deployment/doctor` | frontier | no | yes | packages/gateway/src/server.ts:61741 |
| GET | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:61831 |
| PUT | `/api/frontier/scorecard` | frontier | no | yes | packages/gateway/src/server.ts:61837 |
| GET | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:61890 |
| POST | `/api/frontier/comparator/run` | frontier | no | yes | packages/gateway/src/server.ts:61902 |
| GET | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:61931 |
| POST | `/api/frontier/comparator/closure` | frontier | no | yes | packages/gateway/src/server.ts:61943 |
| POST | `/api/frontier/benchmark/delta` | frontier | no | yes | packages/gateway/src/server.ts:61965 |
| POST | `/api/frontier/critic` | frontier | no | yes | packages/gateway/src/server.ts:62027 |
| POST | `/api/frontier/remediation/plans` | frontier | no | yes | packages/gateway/src/server.ts:62075 |
| GET | `/api/frontier/release/gate` | frontier | no | yes | packages/gateway/src/server.ts:62119 |
| POST | `/api/frontier/certification/report` | frontier | no | yes | packages/gateway/src/server.ts:62176 |
| GET | `/api/certification/runtime` | certification | no | yes | packages/gateway/src/server.ts:62195 |
| POST | `/api/certification/runtime/report` | certification | no | yes | packages/gateway/src/server.ts:62204 |
| GET | `/api/certification/continuity` | certification | no | yes | packages/gateway/src/server.ts:62230 |
| POST | `/api/certification/continuity/report` | certification | no | yes | packages/gateway/src/server.ts:62239 |
| GET | `/api/certification/architecture` | certification | no | yes | packages/gateway/src/server.ts:62261 |
| POST | `/api/certification/architecture/report` | certification | no | yes | packages/gateway/src/server.ts:62270 |
| GET | `/api/vault/status` | vault | no | yes | packages/gateway/src/server.ts:62317 |
| POST | `/api/vault/reset-empty` | vault | no | yes | packages/gateway/src/server.ts:62323 |
| POST | `/api/vault/bootstrap` | vault | no | yes | packages/gateway/src/server.ts:62367 |
| POST | `/api/vault/unlock` | vault | no | yes | packages/gateway/src/server.ts:62401 |
| POST | `/api/vault/lock` | vault | no | yes | packages/gateway/src/server.ts:62461 |
| GET | `/api/vault/secrets` | vault | no | yes | packages/gateway/src/server.ts:62485 |
| PUT | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:62493 |
| POST | `/api/vault/secrets/:name/rotate` | vault | no | yes | packages/gateway/src/server.ts:62552 |
| DELETE | `/api/vault/secrets/:name` | vault | no | yes | packages/gateway/src/server.ts:62592 |
| POST | `/api/vault/rotate-master-key` | vault | no | yes | packages/gateway/src/server.ts:62658 |
| GET | `/api/backup/export` | backup | no | yes | packages/gateway/src/server.ts:62702 |
| GET | `/` | root | yes | yes | packages/gateway/src/server.ts:62743 |
| GET | `/*` | * | yes | yes | packages/gateway/src/server.ts:62749 |
